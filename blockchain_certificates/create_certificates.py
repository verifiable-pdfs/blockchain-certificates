...
def main():
    ...
    conf = load_config()
    pdf_certificates.populate_pdf_certificates(conf)
    cert_hashes = pdf_certificates.hash_certificates(conf)
    pdf_certificates.create_certificates_index(conf, cert_hashes)
